...
namespace Gate2Reality.Detection
{
    ...
    public sealed class YoloObjectDetector : MonoBehaviour
    {
        ...
        // Преаллоцированный массив нарративных COCO-классов — zero-GC в Update
        private static readonly int[] s_RelevantClasses = {
            CocoCup,CocoChair,CocoBook,CocoTable,CocoTv,CocoLaptop,CocoPhone,
            CocoBottle,CocoBowl,CocoFork,CocoKnife,CocoScissors,
            CocoTeddyBear,CocoBackpack,CocoCouch,CocoBed,CocoBicycle
        };
        ...
        private const int CocoTable=60,CocoTv=62,CocoLaptop=63,CocoPhone=67;
        private const int CocoBottle=39,CocoBowl=45,CocoFork=42,CocoKnife=43;
        private const int CocoScissors=76,CocoTeddyBear=77,CocoBackpack=26;
        private const int CocoCouch=57,CocoBed=59,CocoBicycle=1;
        ...
        private void PostProcess(Tensor<float> output)
        {
            ...
            for (int i = 0; i < anchors; i++)
            {
                ...
                int cls=-1; float best=0f;
                for(int ci=0;ci<s_RelevantClasses.Length;ci++){
                    float s=output[0,4+s_RelevantClasses[ci],i];
                    if(s>best){best=s;cls=s_RelevantClasses[ci];}
                }
                if(cls<0||best<scoreThreshold)continue;
        ...
        private static NarrativeLabel MapLabel(int cocoClass)
        {
            switch(cocoClass){
                ...
                case CocoTable:     return NarrativeLabel.Table;
                case CocoTv:        return NarrativeLabel.Tv;
                case CocoLaptop:    return NarrativeLabel.Laptop;
                case CocoPhone:     return NarrativeLabel.Phone;
                case CocoBottle:    return NarrativeLabel.Bottle;
                case CocoBowl:      return NarrativeLabel.Bowl;
                case CocoFork:      return NarrativeLabel.Fork;
                case CocoKnife:     return NarrativeLabel.Knife;
                case CocoScissors:  return NarrativeLabel.Scissors;
                case CocoTeddyBear: return NarrativeLabel.TeddyBear;
                case CocoBackpack:  return NarrativeLabel.Backpack;
                case CocoCouch:     return NarrativeLabel.Couch;
                case CocoBed:       return NarrativeLabel.Bed;
                case CocoBicycle:   return NarrativeLabel.Bicycle;
