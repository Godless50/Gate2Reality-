...
namespace Gate2Reality
{
    ...
    public sealed class DeviceTuningProfile : MonoBehaviour
    {
        ...
        private static Tier DetectTier() =>
            DetectTierFromInfo(SystemInfo.graphicsDeviceName ?? string.Empty, SystemInfo.systemMemorySize);

        // internal для EditMode-тестов
        internal static Tier DetectTierFromInfo(string gpu, int ramMb)
        {
        ...
        internal static bool Contains(string s, string sub) =>
